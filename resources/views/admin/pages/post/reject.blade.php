                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text-center d-flex justify-content-center align-items-center">
                                                    ...
                                                    <div class="modal-dialog modal-xl">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <iframe src="{{route('post.view',$post->url_key)}}" width="100%" height="500px" title="W3Schools Free Online Web Tutorials"></iframe>
                                                            </div>
                                                ...
                                                <form action="{{ route('post.restore',$post->url_key) }}" method="POST">
                                                    @csrf
                                                    <button type="submit" class="text-success bg-transparent border-0 js-delete-button">
