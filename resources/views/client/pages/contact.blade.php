...
@section('content')
    ...
    <div class=" text-gray-100 px-8 py-12">
        <div
            class="max-w-screen-xl mt-24 mb-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto  text-gray-900 rounded-lg shadow-lg">
            ...
            <div>
                ...
                <form action="{{route('contact.store')}}" method="POST" class="">
                    @csrf
                    <div>
                        <span class="uppercase text-lg text-gray-600 font-bold">Full Name</span>
                        <input
                            name="user_name" autocomplete="user_name"
                    ...
                    <div class="mt-8">
                        <span class="uppercase text-lg text-gray-600 font-bold">Email</span>
                        <input
                            name="email"
                            class="w-full bg-gray-200 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                            type="email">
                    ...
                    <div class="mt-8">
                        <span class="uppercase text-lg text-gray-600 font-bold">Title</span>
                        <input
                            name="title"
                            class="w-full bg-gray-200 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                            type="text">
                    ...
                    <div class="mt-8">
                        <span class="uppercase text-lg text-gray-600 font-bold">Message</span>
                        <textarea
                            name="message"
